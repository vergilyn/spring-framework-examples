...
public class CronTrigger implements Trigger {
	...
	public Date nextExecutionTime(TriggerContext triggerContext) {
		num++;
		System.out.print(num +" ,"+triggerContext +"-"+this.getExpression()+" ,beg:" + sdf.format(new Date()));
		Date date = triggerContext.lastCompletionTime();
		System.out.print(" ,in: " + (date != null ? sdf.format(date) : null));
		if (date != null) {
			Date scheduled = triggerContext.lastScheduledExecutionTime();
			System.out.print(" ,sch: " + (scheduled != null ? sdf.format(scheduled) : null));
		...
		System.out.println(" ,next: " +( date != null ? sdf.format(date) : null));
